                                   ...
                                   <div class="row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            <div class="row">
                                             <div class="col-4">
                                                 <label class="checkbox-inline">Data User</label>
                                             </div>
                                             <div class="col-2">
                                                 <input type="checkbox" id="menu_1" name="menu_1" checked data-toggle="toggle">
                                             </div>
                                            </div>
                                         </div>
                                         <div class="form-group">
                                             <div class="row">
                                                 <div class="col-4">
                                                     <label class="checkbox-inline">Hak Akses</label>
                                                 </div>
                                                 <div class="col-2">
                                                     <input type="checkbox" id="menu_2" name="menu_2"  checked data-toggle="toggle">                                            </div>
                                                </div>
                                         </div>
                                         <div class="form-group">
                                             <div class="row">
                                                 <div class="col-4">
                                                     <label class="checkbox-inline">Data Kategori</label>
                                                 </div>
                                                 <div class="col-2">
                                                     <input type="checkbox" id="menu_3" name="menu_3" checked data-toggle="toggle">
                                                 </div>
                                                </div>
                                         </div>
                                         <div class="form-group">
                                            <div class="row">
                                             <div class="col-4">
                                                 <label class="checkbox-inline">Data Barang</label>
                                             </div>
                                             <div class="col-2">
                                                 <input type="checkbox" id="menu_4" name="menu_4" checked data-toggle="toggle">
                                             </div>
                                            </div>
                                         </div>
                                         <div class="form-group">
                                             <div class="row">
                                                 <div class="col-4">
                                                     <label class="checkbox-inline">Data Satuan</label>
                                                 </div>
                                                 <div class="col-2">
                                                     <input type="checkbox" id="menu_4" name="menu_4" checked data-toggle="toggle">                                            </div>
                                                </div>
                                         </div>
                                         <div class="form-group">
                                             <div class="row">
                                                 <div class="col-4">
                                                     <label class="checkbox-inline">Data Pelanggan</label>
                                                 </div>
                                                 <div class="col-2">
                                                     <input type="checkbox" id="menu_5" name="menu_5" checked data-toggle="toggle">
                                                 </div>
                                                </div>
                                         </div>
                                         <div class="form-group">
                                            <div class="row">
                                                <div class="col-4">
                                                    <label class="checkbox-inline">Riwayat Hutang</label>
                                                </div>
                                                <div class="col-2">
                                                    <input type="checkbox" id="menu_6" name="menu_6" checked data-toggle="toggle">
                                                </div>
                                               </div>
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="form-group">
                                            <div class="row">
                                             <div class="col-4">
                                                 <label class="checkbox-inline">Data Mitra</label>
                                             </div>
                                             <div class="col-2">
                                                 <input type="checkbox" id="menu_7" name="menu_7" checked data-toggle="toggle">
                                             </div>
                                            </div>
                                         </div>
                                         <div class="form-group">
                                             <div class="row">
                                                 <div class="col-4">
                                                     <label class="checkbox-inline">Stok Barang</label>
                                                 </div>
                                                 <div class="col-2">
                                                     <input type="checkbox" id="menu_8" name="menu_8" checked data-toggle="toggle">                                            </div>
                                                </div>
                                         </div>
                                         <div class="form-group">
                                             <div class="row">
                                                 <div class="col-4">
                                                     <label class="checkbox-inline">Pembelian</label>
                                                 </div>
                                                 <div class="col-2">
                                         ...
                                         <div class="form-group">
                                            <div class="row">
                                             <div class="col-4">
                                                 <label class="checkbox-inline">Penjualan Mitra</label>
                                             </div>
                                             <div class="col-2">
                                                 <input type="checkbox" checked data-toggle="toggle">
                                             </div>
                                         ...
                                         <div class="form-group">
                                             <div class="row">
                                                 <div class="col-4">
                                                     <label class="checkbox-inline">Penjualan Reguler</label>
                                                 </div>
                                                 <div class="col-2">
                                         ...
                                         <div class="form-group">
                                             <div class="row">
                                                 <div class="col-4">
                                                     <label class="checkbox-inline">Riwayat Transaksi</label>
                                                 </div>
                                                 <div class="col-2">
                                                     <input type="checkbox" checked data-toggle="toggle">
                                                 </div>
