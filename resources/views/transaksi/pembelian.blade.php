            ...
            <table name="tblData" class="table table-borderless">
                ...
                <tfoot>
                    ...
                    <tr class="table-light">
                        ...
                        &nbsp;
                        <td><input type="text" name="total_bayar" value="0" jAutoCalc="" class="form-control">
                        </td>
                    </tr>
                </tfoot>
            </table>
	...
	<script type="text/javascript">
        ...
        $("#btnAdd").click(function () {
                ...
                if(nama_barang != "" && jumlah != "" && harga_beli != "" ){
                    ...
                    var dynamicTr ="<tr class='line_items  table table-grey'><td><input type='button' class='btn btn-danger btn-sm' value='Hapus'></td><td><span>"+nama_barang+"</span></td><td><input type='text' name='qty' value='' class='form-control'></td><td><input type='text' name='price' value='' class='form-control'></td>&nbsp;<td><input type='text' name='item_total' value='0' jAutoCalc='{qty} * {price}' class='form-control'></td></tr>";
