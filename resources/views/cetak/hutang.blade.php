                        ...
                        <div class="modal-body">
                            ...
                            <input type="hidden" name="id" id="id">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            <div class="form-group">
                                                <label for="name" class="col-sm control-label">Sudah Dibayar</label>
                                                <div class="col-sm-12">
                                                    <input type="hidden" class="form-control" id="total_bayar" name="total_bayar" jAutoCalc="{total} + {bayar}" placeholder="Masukkan Harga Hutang" value="" maxlength="50" required="">
                                                    <input type="text" class="form-control" id="total" name="total" placeholder="Masukkan Harga Hutang" value="" maxlength="50" required="">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-12">
                                                    <input type="text" class="form-control" name="sisa" id="sisa"  placeholder="Masukkan Harga Hutang" value="" maxlength="50" required="">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                <div class="form-group">
                                                    <label for="name" class="col-sm control-label">Hutang Sekarang</label>
                                                    <div class="col-sm-12">
                                                        <input type="text" class="form-control" jAutoCalc="{sisa} - {bayar}" id="sisa_hutang" name="sisa_hutang" placeholder="Masukkan Harga Hutang" value="" maxlength="50" required="">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col">
...
<script type="text/javascript">
        ...
        $('#total').val(data.total_bayar).attr("disabled", false);
        $('#sisa').val(data.sisa_hutang).prop('readonly', false);
